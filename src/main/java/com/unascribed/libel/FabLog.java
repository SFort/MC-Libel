...
public class FabLog {
	...
	public static Logger log = LogManager.getLogger("Libel");
	...
	private static final boolean FAKE_DEBUG = Boolean.getBoolean("libel.debug") && FabConf.isMet(SpecialEligibility.NOT_FORGE);
