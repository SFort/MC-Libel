...
public class FabLog {
	...
	public static Logger log = LogManager.getLogger("Mirage");
	...
	private static final boolean FAKE_DEBUG = Boolean.getBoolean("mirage.debug") && FabConf.isMet(SpecialEligibility.NOT_FORGE);
