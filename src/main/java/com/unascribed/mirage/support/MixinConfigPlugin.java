...
import com.unascribed.mirage.Agnos;
import com.unascribed.mirage.FabConf;
import com.unascribed.mirage.FabLog;
import com.unascribed.mirage.FabricationMod;
import com.unascribed.mirage.support.injection.FailsoftCallbackInjectionInfo;
import com.unascribed.mirage.support.injection.FailsoftModifyArgInjectionInfo;
import com.unascribed.mirage.support.injection.FailsoftModifyArgsInjectionInfo;
import com.unascribed.mirage.support.injection.FailsoftModifyConstantInjectionInfo;
import com.unascribed.mirage.support.injection.FailsoftModifyVariableInjectionInfo;
import com.unascribed.mirage.support.injection.FailsoftRedirectInjectionInfo;
import com.unascribed.mirage.support.injection.FabInjector;
		...
		targetClass.methods.forEach(methodNode -> {
			for (ListIterator<AbstractInsnNode> it = methodNode.instructions.iterator(); it.hasNext();) {
				...
				if (insnNode instanceof MethodInsnNode) {
					...
					if (insn.getOpcode() == Opcodes.INVOKESTATIC && "com/unascribed/mirage/FabConf".equals(insn.owner) && "(Ljava/lang/String;)Z".equals(insn.desc)) {
